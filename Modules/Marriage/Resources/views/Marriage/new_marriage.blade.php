			...
			<form id="wizard-vertical">
				...
				<section>
					<div class="form-group clearfix">
						<label class="col-lg-3 control-label " for="husband_last_name">Husband First Name</label>
						<div class="col-lg-9">
							<input placeholder="Husband First Name" class="form-control required" id="userName1" name="husband_last_name" type="text">
						</div>
					</div>
					<div class="form-group clearfix">
						<label class="col-lg-3 control-label " for="husband_last_name">Husband Last Name</label>
						<div class="col-lg-9">
				...
				<section>
					<div class="form-group clearfix">
						<label class="col-lg-3 control-label " for="wife_first_name">Wife First Name</label>
						<div class="col-lg-9">
							<input placeholder="Wife First Name" class="form-control required" id="wife_first_name" name="wife_first_name" type="text">
						</div>
					</div>
					<div class="form-group clearfix">
						<label class="col-lg-3 control-label " for="wife_last_name">Wife last Name</label>
						<div class="col-lg-9">
				...
				<section>
					<div class="form-group clearfix">
						<label class="col-lg-3 control-label " for="mdate">Date Of Marriage</label>
						<div class="col-lg-9">
                    ...
                    <div class="widget-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="yes">
                                <div class="form-group clearfix">
                                    <label class="col-lg-3 control-label " for="wfamily">Family Title</label>
                                    <div class="col-lg-9">
