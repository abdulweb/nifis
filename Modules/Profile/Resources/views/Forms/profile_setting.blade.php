    ...
    <div class="widget-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="account-details">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" value="{{'house no'}}" class="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" value="{{'house description'}}" class="form-control" />
                                </div>
                            </div>
                            <!-- // Group END -->
                    ...
                    Biography<br />
                    <textarea name="about"id="mustHaveId" class="wysihtml5 form-control" rows="5">{{'biography'}}</textarea>
